...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        default:
          "bg-brand-orange text-white hover:bg-brand-orange-dark shadow-md hover:shadow-lg",
        secondary:
          "bg-brand-green text-white hover:bg-brand-green-dark shadow-md hover:shadow-lg",
        outline:
        ...
        soft: "bg-brand-orange/10 text-brand-orange hover:bg-brand-orange/20",
        "soft-green": "bg-brand-green/10 text-brand-green hover:bg-brand-green/20",
      },
      size: {
